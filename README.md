...
Two parts of Express we learned about are Router and middleware. Routing allows for use of HTTP methods. Middleware is described next.

- [x] Describe Middleware?

Middleware is software that is simply stated, put in the middle of two other parts of the application. Middleware has access to the HTTP request and response for each router that it is attached too, and is thus modular as well. This allows you additional control over each router or resource.

- [x] Describe a Resource?

A resource is the main concept of RESTful APIs and is an object that has some methods that are often assocaited data or relationships.

- [x] What can the API return to help clients know if a request was successful?

An API can use the HTTP status codes to respond to the client, informing the client a request was successful. Other responses such as not found, redirect and other errors can be used as well.
